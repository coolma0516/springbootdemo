# Demo project for Spring Boot 2.0 

This application use the Spring Boot 2.0 as the Backend, and we use the React and Typescript in the Frontend. We have the user credential verification module using the Spring Security and JWT as our stateless authentication. 
## Development
...
To build the final jar and optimize the trashhelper application for production, run:
